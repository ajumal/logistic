                                ...
                                <div className="row row-sm">
                                    <div className="col-lg-6 col-xl-6 d-none d-lg-block text-center  details">
                                        <div className="mt-3 p-2">
                                            <img src="images/logo.svg" className="header-brand-img mb-4" alt="logo" />
                                            <div className="clearfix"></div>
                                            <img src="images/login_img.svg" className="ht-100 mb-0" alt="user" />
                                        </div>
                                    </div>
                                        ...
                                        <div className="container-fluid">
                                            <div className="row row-sm">
                                                <div className="card-body mt-2 mb-2">
                                                    <img src="images/logo.svg" className=" d-lg-none header-brand-img text-left float-left mb-4" alt="logo" />
                                                    <div className="clearfix"></div>
                                                    <form>
                                                        <h5 className="text-left mb-2 font-20">Signin to Your Account</h5>
                                                        <p className="mb-4 text-muted tx-13 ml-0 text-left">Signin to create, discover and connect with Yolojet</p>
